...
export function resetDb() {
  db.exec('DELETE FROM player_watches; DELETE FROM fcm_credentials; DELETE FROM rustplus_pairings; DELETE FROM timers; DELETE FROM events; DELETE FROM servers; DELETE FROM links; DELETE FROM link_codes; DELETE FROM deaths;');
}
